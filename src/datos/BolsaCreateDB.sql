ALTER TABLE VALORES DROP CONSTRAINT CATEGORIA_FK;
ALTER TABLE DATOS_VALORES DROP CONSTRAINT COD_VALOR_FK;
DROP TABLE CATEGORIAS;
DROP TABLE PATRON_DATOS;
DROP TABLE OPERACIONES;
DROP TABLE VALORES;
DROP TABLE DATOS_VALORES;
DROP TABLE INDICADORES;
DROP TABLE FICHEROS_TRATADOS;
...
CREATE TABLE VALORES (
    ...
    CONSTRAINT CATEGORIA_FK FOREIGN KEY (COD_CAT) REFERENCES CATEGORIAS (COD_CAT)
);
...
CREATE TABLE DATOS_VALORES (
    ...
    CONSTRAINT COD_VALOR_FK FOREIGN KEY (COD_VALOR) REFERENCES VALORES (COD_VALOR)
);
